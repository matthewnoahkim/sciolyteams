  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0f] text-gray-900 dark:text-white transition-colors">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        {/* Gradient orbs */}
        <div className="absolute top-1/4 right-1/4 w-[600px] h-[600px] bg-gradient-to-r from-emerald-500/10 dark:from-emerald-600/20 to-cyan-500/10 dark:to-cyan-600/20 rounded-full mix-blend-normal dark:mix-blend-screen filter blur-[120px] animate-blob opacity-70 dark:opacity-100" />
        <div className="absolute bottom-1/4 left-1/4 w-[500px] h-[500px] bg-gradient-to-r from-violet-500/10 dark:from-violet-500/15 to-fuchsia-500/10 dark:to-fuchsia-600/15 rounded-full mix-blend-normal dark:mix-blend-screen filter blur-[100px] animate-blob animation-delay-2000 opacity-70 dark:opacity-100" />
