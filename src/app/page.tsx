...
import { Calendar, Users2, ClipboardCheck, DollarSign, FileText, MessageSquare, Shield, Zap, BarChart3, HelpCircle } from 'lucide-react'
        ...
        <div className="max-w-6xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white leading-tight">
              Manage Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Team Better</span>
            </h2>
          ...
          <div className="flex justify-center gap-4 pt-4">
            <Link href="/login">
              <button className="px-8 py-3 text-lg font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-lg hover:shadow-xl transition-all">
                Get Started
              </button>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-12 max-w-4xl mx-auto">
            <div className="flex flex-col items-center gap-3 p-6 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-lg transition-shadow">
              <Calendar className="h-8 w-8 text-blue-600 dark:text-blue-400" />
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Events</span>
            </div>
            <div className="flex flex-col items-center gap-3 p-6 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-lg transition-shadow">
              <Users2 className="h-8 w-8 text-purple-600 dark:text-purple-400" />
