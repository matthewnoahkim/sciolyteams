            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-16 max-w-4xl mx-auto">
              <div className="group p-6 rounded-2xl bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border border-gray-200/50 dark:border-gray-800/50 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-300 hover:shadow-xl hover:scale-105">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div className="text-sm font-medium text-gray-600 dark:text-gray-400 text-center">Event Management</div>
                </div>
              </div>
              <div className="group p-6 rounded-2xl bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border border-gray-200/50 dark:border-gray-800/50 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-300 hover:shadow-xl hover:scale-105">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div className="text-sm font-medium text-gray-600 dark:text-gray-400 text-center">Team Organization</div>
                </div>
              </div>
              <div className="group p-6 rounded-2xl bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border border-gray-200/50 dark:border-gray-800/50 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-300 hover:shadow-xl hover:scale-105">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div className="text-sm font-medium text-gray-600 dark:text-gray-400 text-center">Attendance Tracking</div>
                </div>
              </div>
              <div className="group p-6 rounded-2xl bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border border-gray-200/50 dark:border-gray-800/50 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-300 hover:shadow-xl hover:scale-105">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <div className="text-sm font-medium text-gray-600 dark:text-gray-400 text-center">Finance Management</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group relative p-8 rounded-3xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-800/50 hover:border-transparent transition-all duration-500 hover:shadow-2xl hover:scale-105 overflow-hidden"
                >
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4 pt-4">
                {benefits.map((benefit, index) => (
                  <div key={index} className="flex items-center gap-3 p-4 rounded-xl bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border border-gray-200/50 dark:border-gray-800/50">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="group p-8 rounded-2xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-800/50 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-300 hover:shadow-xl"
              >
